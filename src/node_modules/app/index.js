...
module.exports = service => {
  ...
  router.post(
    "/authenticateadmin",
    jsonApiWrapper(auth.authenticateAdmin)("token")
  );
  ...
  router.get(
    "/users/me",
    auth.authMiddleware,
    jsonApiWrapper(users.getMe)("user")
  );
  router.post(
    "/users/me/tickets",
    auth.authMiddleware,
  ...
  router.delete(
    "/prizes/:id",
    auth.authAdminMiddleware,
    jsonApiWrapper(prizes.delete)("prize")
  );

  router.get(
    "/users",
    auth.authAdminMiddleware,
    jsonApiWrapper(users.getAll)("user")
  );
  router.get(
    "/users/:id",
    auth.authAdminMiddleware,
    jsonApiWrapper(users.get)("user")
  );
  router.put(
    "/users/:id",
    auth.authAdminMiddleware,
  ...
  router.post(
    "/users",
    auth.authAdminMiddleware,
    jsonApiWrapper(users.new)("user")
  );
  router.delete(
    "/users/:id",
    auth.authAdminMiddleware,
    jsonApiWrapper(users.delete)("user")
  );
